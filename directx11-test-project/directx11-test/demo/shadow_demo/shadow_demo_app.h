...
namespace xtest {
	namespace demo {
		...
		*/
		...
		class ShawdowsDemoApp : public application::DirectxApp, public input::MouseListener, public input::KeyboardListener
		{
		public:
			...
			ShawdowsDemoApp(HINSTANCE instance, const application::WindowSettings& windowSettings, const application::DirectxSettings& directxSettings, uint32 fps = 60);
			~ShawdowsDemoApp();

			ShawdowsDemoApp(ShawdowsDemoApp&&) = delete;
			ShawdowsDemoApp(const ShawdowsDemoApp&) = delete;
			ShawdowsDemoApp& operator=(ShawdowsDemoApp&&) = delete;
			ShawdowsDemoApp& operator=(const ShawdowsDemoApp&) = delete;
