...
void BoxDemoApp::InitMatrices()
{
	...
	FXMVECTOR eyePosition = XMVectorSet(0.0f, 5.0f, -10.0f, 1.0f);
	...
	float fovAngleY = math::ToRadians(45.f);
...
void BoxDemoApp::InitShaders()
{
	...
	XTEST_D3D_CHECK(m_d3dDevice->CreateInputLayout(vertexDesc, 2, vsByteCode.Data(), vsByteCode.ByteSize(), m_inputLayout.GetAddressOf()));
}
...
void BoxDemoApp::InitBuffers()
{
	...
	VertexIn vertices[] = 
	{
		{ XMFLOAT3(+1.f, +1.f, +1.f), XMFLOAT4(DirectX::Colors::Orange)},			// 0
		{ XMFLOAT3(+1.f, -1.f, +1.f), XMFLOAT4(DirectX::Colors::DarkRed)},			// 1
		{ XMFLOAT3(-1.f, -1.f, +1.f), XMFLOAT4(DirectX::Colors::DarkRed)},	// 2
		{ XMFLOAT3(-1.f, +1.f, +1.f), XMFLOAT4(DirectX::Colors::Orange)},			// 3
		{ XMFLOAT3(+1.f, +1.f, -1.f), XMFLOAT4(DirectX::Colors::Orange)},			// 4
		{ XMFLOAT3(+1.f, -1.f, -1.f), XMFLOAT4(DirectX::Colors::DarkRed)},			// 5
		{ XMFLOAT3(-1.f, -1.f, -1.f), XMFLOAT4(DirectX::Colors::DarkRed)},	// 6	
		{ XMFLOAT3(-1.f, +1.f, -1.f), XMFLOAT4(DirectX::Colors::Orange)}			// 7
	};
...
{ 
	...
	XMMATRIX rotation = XMMatrixRotationY(math::ToRadians(180.0f) * deltaSeconds);
